...
class ClubNewsViewTest(myTestCase):
    ...
    #     """тест: у новости в списке новосте есть описание не юолее 100
    #     символов"""
...
# 3) Проверить, чтобы все обьекты били правильными либо наборы queryset
# имели правильные элементы.
# 4) Проверить, чтобы все формы имели правильный класс.
# 5) ПОдумать о тестировании логики шаблона: любой оператор for или if
# может заслужить минимального теста.
...
# 7) Факультативно проверить на исправность, что форма выведена в качестве
# HTML и ее ошибки визуально отображаются
